    ...
    def create_block(self, proof, previous_hash):
        block = {
            'index': len(self.chain) + 1,
                 ...
                 'surname': str(database[2].iloc[len(self.chain)]),
                 'lastname': str(database[3].iloc[len(self.chain)]),
                 'birtday': str(database[4].iloc[len(self.chain)]),
                 'passport': str(database[5].iloc[len(self.chain)]),
                 'vote': str(database[6].iloc[len(self.chain)]),
